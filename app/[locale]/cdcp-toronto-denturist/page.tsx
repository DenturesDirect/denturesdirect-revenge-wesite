...
export default function CdcpPillar() {
  ...
  const c = getCdcpContent(locale).pillar;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="bg-brand-dark text-white rounded-3xl p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <span className="inline-block px-4 py-1 bg-brand-blue text-white font-bold rounded-full text-sm mb-6 uppercase tracking-wider">{c.badge}</span>
            <h1 className="text-5xl font-extrabold text-brand-light mb-6">{c.h1}</h1>
